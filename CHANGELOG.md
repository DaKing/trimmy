...
- Trimmy is now available via Homebrew: `brew install --cask steipete/tap/trimmy` (updates via `brew upgrade --cask steipete/tap/trimmy`). When installed via Homebrew, Sparkle is disabled.
